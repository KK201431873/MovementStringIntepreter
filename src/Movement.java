...
public class Movement {
	public enum MovementType {
		...
		MovementType(double SGN_forward, double SGN_strafe, double SGN_turn, double SGN_elevation, boolean isDriveType,
				boolean isTurnType, boolean isClawType, boolean isArmType, boolean isCVType) {
	...
	Movement(MovementType type, double forward, double strafe, double turn, double elevation, double servoPosition,
			long wait) {
